...
-- default callback to colorscheme switching
local function update_theme()
    ...
    -- colorcolumn for jellybeans-nvim
    if vim.g.colors_name == "jellybeans-nvim" then
        vim.api.nvim_set_hl(0, "ColorColumn", { bg = "#181818" })
    end
end

vim.api.nvim_create_autocmd("ColorScheme", { callback = update_theme })
update_theme()
